...
plt.annotate('Terjadi lonjakan', xy=(7,310), xytext=(8, 399), weight='bold', color='red', arrowprops=dict(arrowstyle='->', connectionstyle="arc3", color='red'))
